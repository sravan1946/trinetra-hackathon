...
from typing_extensions import Dict, List, Self, Union, Optional
...
class Chapter:
    ...
    def __init__(self, auth: Union[Auth, None] = None) -> None:
        ...
        self.chapter_id: str = ""
        self.title: str = ""
        self.volume: Optional[str] = ""
        self.chapter: Optional[float] = None
    ...
    def __repr__(self) -> str:
        ...
        # return f"{part1}"
        return f"<Chapter chapther_id={self.chapter_id} title={self.title} volume={self.volume} chapter={self.chapter} translatedLanguage={self.translatedLanguage} createdAt={self.createdAt} updatedAt={self.updatedAt} publishAt={self.publishAt} manga_id={self.manga_id} group_id={self.group_id} uploader={self.uploader}>"
